	...
	void DrawFullScreenStuff()
	{
		...
		if(plr) {
			...
			{   
				...
				else if(CheckInventory("VoidGrenadeSelected")) {
					PBHud_DrawImage("HVOIDY", (-24, -23), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_RIGHT_BOTTOM, scale: (1.25, 1.25));
					PBHud_DrawString(mBoldFont, Formatnumber(GetAmount("VoidGrenadeAmmo")), (-38, -37), DI_TEXT_ALIGN_RIGHT, Font.CR_UNTRANSLATED, scale: (0.8, 0.8));
				}
				else if(CheckInventory("SwarmerSelected")) {
					PBHud_DrawImage("HSWRMY", (-24, -23), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_RIGHT_BOTTOM, scale: (1.25, 1.25));
					PBHud_DrawString(mBoldFont, Formatnumber(GetAmount("SwarmerAmmo")), (-38, -37), DI_TEXT_ALIGN_RIGHT, Font.CR_UNTRANSLATED, scale: (0.8, 0.8));
				}
				else if(CheckInventory("LaserChargeSelected")) {
					PBHud_DrawImage("HLASRY", (-24, -23), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_RIGHT_BOTTOM, scale: (1.25, 1.25));
					PBHud_DrawString(mBoldFont, Formatnumber(GetAmount("LaserChargeAmmo")), (-38, -37), DI_TEXT_ALIGN_RIGHT, Font.CR_UNTRANSLATED, scale: (0.8, 0.8));
				}
				else if(CheckInventory("AcidChargeSelected")) {
